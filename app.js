...
function chooseArea(block){
    ...
    if(gameOver){
        ...
        blocks.forEach(block => block.style.pointerEvent='none');
    }
}
...
function checkRows(){
    ...
    blocks[0].textContent==blocks[2].textContent && blocks[0] !==""

    let row2 =blocks[3].textContent==blocks[4].textContent && 
    blocks[3].textContent==blocks[5].textContent && blocks[3] !==""

    let row3 =blocks[6].textContent==blocks[7].textContent && 
    blocks[6].textContent==blocks[8].textContent && blocks[6] !==""
...
function checkColumns(){
    ...
    blocks[0].textContent==blocks[6].textContent && blocks[0] !==""

    let col2 =blocks[1].textContent==blocks[4].textContent && 
    blocks[1].textContent==blocks[7].textContent && blocks[1] !==""

    let col3 =blocks[2].textContent==blocks[5].textContent && 
    blocks[2].textContent==blocks[8].textContent && blocks[2] !==""
...
function checkDiagonals(){
    ...
    blocks[0].textContent==blocks[8].textContent && blocks[0] !==""

    let dia2 =blocks[2].textContent==blocks[4].textContent && 
    blocks[2].textContent==blocks[6].textContent && blocks[2] !==""
